...
_Updated 2026-09-18T08:19:19Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2025-07-31 |
| Tracked by repo-vitals since | 2026-06-25 (86 days)³ |
...
Everything recorded so far, from 2026-06-25 (86 days) — the total, and the same total expressed as an average rate.
...
**Conversion funnel (30 d):** 3 unique visitors → 96 unique cloners → 0 stars gained → 0 downloads gained
...
[reports/biterik-pdf-paper-renaming-2026-09-18.md](reports/biterik-pdf-paper-renaming-2026-09-18.md)
