...
_Updated 2026-09-19T08:07:24Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_

| | |
|---|---|
| Repository created | 2025-07-31 |
| Tracked by repo-vitals since | 2026-06-25 (87 days)³ |
...
| Clones | 124 | 311 | 311 |
| Stars gained | 0 | 0 | 0 |
| Release downloads gained | 0 | 1 | 1 |

¹ sum of daily unique counts — an upper bound on true period uniques.

## Since tracking began

Everything recorded so far, from 2026-06-25 (87 days) — the total, and the same total expressed as an average rate.

| Metric | Total | Average / 30 d |
|---|---:|---:|
| Views | 5 | 1.7 |
| Unique visitors¹ | 4 | 1.4 |
| Clones | 311 | 107.2 |
| Unique cloners¹ | 226 | 77.9 |
| Stars gained | 0 | 0.0 |
| Release downloads gained | 1 | 0.3 |
...
**Conversion funnel (30 d):** 3 unique visitors → 101 unique cloners → 0 stars gained → 0 downloads gained
...
|---|---:|---:|
| `/biterik/pdf-paper-renaming` | 1 | 1 |
...
[reports/biterik-pdf-paper-renaming-2026-09-19.md](reports/biterik-pdf-paper-renaming-2026-09-19.md)
