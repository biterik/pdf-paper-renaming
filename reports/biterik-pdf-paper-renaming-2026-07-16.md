...
_Updated 2026-07-16T05:56:30Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_
...
**Health: 48/100** (heuristic² — traffic trend 100, activity 19, community 8, release adoption 11)
...
**Conversion funnel (30 d):** 1 unique visitors → 40 unique cloners → 0 stars gained → 1 downloads gained
...
|---|---:|---:|
| `/biterik/pdf-paper-renaming/releases/tag/v2.0` | 1 | 1 |
...
2 commits · 1 PRs opened / 1 merged · 0 issues opened / 0 closed · 1 contributors total
...
[reports/biterik-pdf-paper-renaming-2026-07-16.md](reports/biterik-pdf-paper-renaming-2026-07-16.md)
